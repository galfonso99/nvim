...
vim.opt.mouse = 'a'  -- Enable mouse in every vim mode

vim.opt.showmode = false

-- Sync clipboard between OS and Neovim.  UnnamedPlus
...
vim.keymap.set('n', '<leader>rf', '<cmd>Genghis renameFile<cr>', { silent = true, noremap = true })
...
vim.keymap.set('n', '<Leader>tn', '<cmd>terminal<cr>', { silent = true, noremap = true })
...
-- Autocommand for removing semantic Tokens
